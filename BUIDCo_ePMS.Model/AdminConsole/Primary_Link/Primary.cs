...
namespace BUIDCO.Domain.AdminConsole.Primary_Link
{   
    ...
    public class UpdatePrimaryLink
    {
        ...
        public string NVCHPLINKNAMEHIN { get; set; }
        public string NVCHPLINKNAMEURD { get; set; }
    ...
    public class PrimaryModel
    {
        ...
        public int FunctionId { get; set; }
        public string PlinkName { get; set; }
        public string PlinkNameHin { get; set; }
        public string PlinkNameUrd { get; set; }

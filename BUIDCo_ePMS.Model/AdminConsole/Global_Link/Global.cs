...
namespace BUIDCO.Domain.AdminConsole.Global_Link
{
    ...
    public class ViewGlobal
    {
        ...
        public string nvchGLinkNameHin { get; set; }
        public string nvchGLinkNameUrd { get; set; }
        public string VCHICONCLASS { get; set; }
        public int updatedBy { get; set; }
        public int GintSortNum { get; set; }
        public int GMAxid { get; set; }
        public string GlobalLinkName { get; set; }
        public string GlobalLinkNameH { get; set; }
        public string GlobalLinkNameU { get; set; }
        public int CreatedBy { get; set; }

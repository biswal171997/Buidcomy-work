...
{
    public class SendSMSRepository : Db_BUIDCo_PMSRepositoryBase, ISendSMSRepository
    {
        private readonly ILogger<SendSMSRepository> Logger;
        public SendSMSRepository(IDb_BUIDCo_PMSConnectionFactory connectionFactory, ILogger<SendSMSRepository> logger) : base(connectionFactory)
        {
            Logger = logger;

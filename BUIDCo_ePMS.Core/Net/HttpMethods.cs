 ...
 public class HttpMethods
    {
        #region POST
        /// <summary>
        /// HTTP POST mode request data
        /// </summary>
        /// <param name="url">URL.</param>
        /// <param name="param">POST data</param>
        /// <returns></returns>
        public static string HttpPost(string url, string param = null)
        {
            HttpWebRequest request;

            //If Yes.Sending an HTTPS request
        ...
        public static string BuildRequest(string strUrl, Dictionary<string, string> dicPara, string fileName)
        {
            ...
            //Converts the request data string Type into a byte stream according to the encoding format
        ...
        #region Delete
        /// <summary>
        /// HTTP Delete mode requests data.
        /// </summary>
        /// <param name="url">URL.</param>
        /// <returns></returns>
        ...
        #region Post With Pic
        /// <summary>
        /// HTTP POST mode request data (Belt picture)
        /// </summary>
        /// <param name="url">URL</param>        
        /// <param name="param">POST data</param>
        /// <param name="fileByte">Pictures</param>
        /// <returns></returns>

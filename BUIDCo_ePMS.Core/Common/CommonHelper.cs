...
namespace BUIDCo_ePMS.Core
{
    public class CommonHelper
    {
        ...
        //public static string SendMobileSMS(string mobile, string otp, string message)
        //{
        //    string Password = "TestCsm@2201";
        //    string userdetails = "Testuser1";
        //    string OPTINS = "WEBSMS";
        //    string template_id = "123";
        //    string msg = " " + message + " is " + otp + ".";
        //    string strUrl = string.Empty;
        //    strUrl = "https://login.bulksmsgateway.in/sendmessage.php?&user=" + userdetails + "&password=" + Password + "&mobile=" + mobile + "&message=" + msg + "&sender=" + OPTINS + "&type=" + 3 + "&template_id=" + template_id;

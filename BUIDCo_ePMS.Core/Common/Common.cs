    ...
    public class Common
    {
        ...
        public static string ValidateCKEditor(string ctlValue, string ctlname)
        {
            try
            {
                ...
                //ctlValue = HttpUtility.HtmlDecode(ctlValue);
                ...
                //{
                //    if (ctlValue.Contains(StringFormat[i]))
                //    {
        ...
        public static string ValidateTextbox_Mandatory_Decimal(string ctlValue, string ctlname, int sz, int minSize = 0)
        {
            try
            {
                ...
                //else if (!(ctlValue.Contains('1') || ctlValue.Contains('2') || ctlValue.Contains('1') || ctlValue.Contains('3')) || ctlValue.Contains('4') || ctlValue.Contains('5') || ctlValue.Contains('6') || ctlValue.Contains('7') || ctlValue.Contains('8') || ctlValue.Contains('9') || ctlValue.Contains('0'))
                //{

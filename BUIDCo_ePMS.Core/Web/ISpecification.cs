...
namespace BUIDCo_ePMS.Core
{
    ...
    public interface ISpecification<T>
    {
        ...
        /// This method Yes. First query all the values ​​from the database, and then filter them according to the expression in memory, 
        /// it will be very slow, if there is more data.
        /// </summary>

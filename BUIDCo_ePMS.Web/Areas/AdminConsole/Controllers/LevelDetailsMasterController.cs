...
namespace BUIDCO.Web.Areas.AdminConsole.Controllers
{
    ...
    public class LevelDetailsMasterController : Controller
    {
        ...
        public ILevelServiceProvider _levelServiceProvider { get; }
        public ILevelDetailsServiceProvider _levelDetailsServiceProvider { get; }
        LevelDetailsMaster model = new LevelDetailsMaster();
        public LevelDetailsMasterController(IHierarchyServiceProvider hirerarchyServiceProvider, ILevelServiceProvider levelServiceProvider, ILevelDetailsServiceProvider levelDetailsServiceProvider)
        {
        ...
        [HttpPost]
        public IActionResult AddLevelDetailsMaster(LevelDetailsMaster objlevel)
        {
            try
            {
        ...
        [HttpPost]
        public IActionResult EditLevelDetails(LevelDetailsMaster objlevel)
        {
            try
            {
                if (objlevel.ParentPosition == 3)
